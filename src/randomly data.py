...
for lx in range(10,31):
    ...
    data = pd.DataFrame({
        ...
        "date": [np.datetime64(f"2024-06-{lx}") for _ in range(60)],
        "time": time_slots
    })
    ...
    with pd.ExcelWriter(f"C:\\Users\\kerol\\OneDrive\\Desktop\\test\\Ehab 06-{lx}-2024.xlsx", engine='xlsxwriter') as writer:
